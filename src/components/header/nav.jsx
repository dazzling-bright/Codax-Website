...
const Nav = () => {
  ...
  return (
    <header className="bg-primaryColor px-4 md:px-8 lg:px-8 flex flex-col py-4 md:flex-row md:items-center">
      <div className="flex justify-between w-full md:w-auto items-center">
        <h1 className="font-extrabold text-5xl tracking-wider font-impacted text-blue-500">
          Codax
        </h1>
        <figure
